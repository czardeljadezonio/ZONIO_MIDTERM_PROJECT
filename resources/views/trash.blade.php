    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-600 dark:text-neutral-400">
                    Manage deleted members - restore or permanently delete
                </p>
            </div>
        ...
        <div class="rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-800">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Members in Trash</p>
                    <h3 class="mt-1 text-2xl font-bold text-neutral-900 dark:text-neutral-100">{{ $members->count() }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-800">
            <div class="flex h-full flex-col p-6">
                <h2 class="mb-4 text-lg font-semibold text-neutral-900 dark:text-neutral-100">Deleted Members</h2>
                ...
                @if($members->isEmpty())
                    <div class="flex flex-1 items-center justify-center rounded-lg border-2 border-dashed border-neutral-300 p-12 dark:border-neutral-600">
                        <div class="text-center">
                            ...
                            <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">No deleted members found.</p>
                        </div>
                    </div>
                @else
                        ...
                        <table class="w-full">
                            <thead class="border-b border-neutral-200 dark:border-neutral-700">
                                <tr>
                                    ...
                                    <th class="pb-3 text-left text-xs font-medium uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Member</th>
                                    <th class="pb-3 text-left text-xs font-medium uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Details</th>
                                    <th class="pb-3 text-left text-xs font-medium uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Plan</th>
                                    ...
                                    <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-700/50">
                                        ...
                                        <td class="py-4">
                                            ...
                                            <div class="text-xs text-neutral-500 dark:text-neutral-500">
                                                Started: {{ \Carbon\Carbon::parse($member->start_date)->format('M d, Y') }}
                                            </div>
                                        </td>
                                        ...
                                        <td class="py-4">
                                            ...
                                            @else
                                                <span class="text-xs text-neutral-500 dark:text-neutral-500">No Plan</span>
                                            @endif
                                        </td>

                                        <td class="py-4 text-sm text-neutral-600 dark:text-neutral-400">
                                            {{ $member->deleted_at->format('M d, Y') }}
                                            <div class="text-xs text-neutral-500">
                                                {{ $member->deleted_at->format('h:i A') }}
                                            </div>
                                        </td>
                                        ...
                                        <td class="py-4">
                                            <div class="flex justify-end gap-2">
                                                ...
                                                <form method="POST" action="{{ route('members.force-delete', $member->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
